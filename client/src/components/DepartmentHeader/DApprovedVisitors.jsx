...
import { FaArrowRight, FaFile, FaFilter, FaRegEye } from "react-icons/fa";
import axios from "axios";
import { useNavigate } from "react-router-dom";
import "./DContainer.css";
import { Formik, Form, Field } from "formik";

const DApprovedVisitors = ({
  userId,
  userName,
  userCategory,
  userDepartment,
  ...
  const onFilter = async (values, { setSubmitting }) => {
    try {
      ...
      const response = await axios.get(
        `${apiUrl}/visitor/filterApprovedVisitorsByDate-dHead`,
        {
          params: {
            from: values.from,
            to: values.to,
            ...
            <tbody>
              {isLoading ? (
                    ...
                    >
                      ...
                      <td className="bg-white p-2" style={{ width: "1%" }}>
                        <FaRegEye
                          ...
                          className="hover:text-red-600 font-bolder text-lg hover:scale-110 duration-300 cursor-pointer"
                          title="View Details"
                        />
                      </td>
                    </tr>
                ...
                <tr>
                  <td
                    colSpan="6"
                    className="text-center italic border border-black py-4"
                  >
...
export default DApprovedVisitors;
